...
function App() {
  ...
  <section id="hero" className="d-flex flex-column justify-content-center align-items-center">
    <div className="hero-container" data-aos="fade-in">
      ...
      <p>I'm a<span className="typed" data-typed-items='Christian,n Eagle Scout,Software Engineer,Georgia Tech Alumni' /> </p>
    </div>
  </section>{/* End Hero */}
  <main id="main">
    {/* ======= About Section ======= */}
	...
	*/}
    ...
    <section id="contact" className="contact">
      <div className="container">
        <div className="section-title">
          <h2>Contact</h2>
          <p>I currently cannot be contacted at this time through the form, but feel free to contact me through cell or email. You can also
        ...
        <div className="row" data-aos="fade-in">
          <div className="col-lg-5 d-flex align-items-stretch">
            <div className="info">
			  ...
			  <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3316.2865198631926!2d-84.39173448479215!3d33.779098480681036!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x88f504670c4255c7%3A0xfe3ba7a1ca5397a5!2sNCR%20Global%20Headquarters!5e0!3m2!1sen!2sus!4v1620890161420!5m2!1sen!2sus" frameBorder={0} style={{border: 0, width: '100%', height: '290px'}} allowFullScreen />
            </div>
          </div>
